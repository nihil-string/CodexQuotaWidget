...
CodexQuotaWidget is an independent, unofficial community project. It is not
...
read-only background Windows UI Automation locator plus an independent external
tool window without cross-process ownership.
